...
fn _main() -> i32 {
  ...
  let result: Result<String, AppError> = match subcommand_name.as_ref() {
      ...
      "inspect" => {
        workon::inspect(subcommand_matches
                          .value_of("PROJECT_NAME")
                          .expect("argument required by clap.rs"),
                        config,
                        &subcommand_logger)
...
For further information please have a look at our README https://github.com/brocode/fw/blob/master/README.org")
    ...
    .subcommand(SubCommand::with_name("setup")
                  ...
                  .arg(Arg::with_name("WORKSPACE_DIR")
                         ...
                         .index(1)
                         .required(true)))
    .subcommand(SubCommand::with_name("reworkon")
                  .aliases(&[".", "rw", "re", "fkbr"])
    ...
    .subcommand(SubCommand::with_name("import")
                  ...
                  .arg(Arg::with_name("PROJECT_DIR")
                         ...
                         .index(1)
                         .required(true)))
    .subcommand(SubCommand::with_name("org-import")
